    ...
    <section className="fixed inset-0 z-10 bg-black bg-opacity-50 flex justify-center items-center p-4 overflow-x-hidden">
      ...
      >
        <button
          ...
          className=" absolute  md:top-8 md:right-8 top-7 right-7 bg-[#055FA8] text-white w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center shadow-xl hover:bg-[#316070] z-30"
          aria-label="Close"
        >
