...
export default function Form({ onClose, isOpen }: FormProps) {
  ...
  return (
    <div className="absolute inset-0 bg-[#055FA8] rounded-[25px] z-20 overflow-hidden">
      ...
      >
        <div className={`${styles.formContainer} flex flex-col gap-3 sm:flex-col md:flex-row w-full max-w-[90vw] md:max-w-[1200px] h-[50vh] md:h-[500px] rounded-[20px] overflow-auto hide-scrollbar `}>
